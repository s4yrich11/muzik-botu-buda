...
# yt_dlp ve FFmpeg ayarları (SoundCloud tabanlı, engelsiz)
ytdl_format_options = {
...
async def play(ctx, *, search: str):
    ...
    async with ctx.typing():
        # YouTube engeline takılmamak için aramaları SoundCloud üzerinden yapıyoruz
...
# 3. Başlatma Bloğu (Flask ve Botu Birlikte Çalıştırır)

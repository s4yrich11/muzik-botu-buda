...
@bot.command(name='çal', help='YouTube\'dan müzik çalar.')
...
# Kodun en altına dikkat: Render ortam değişkeninden portu alır
if __name__ == "__main__":
    import threading
    # Flask'ı arka planda (port çakışmasını önlemek için standart portla veya Render portuyla) başlatıyoruz
    port = int(os.environ.get("PORT", 10000))
    
    # Flask'ı ayrı bir thread'de baslatmak yerine Gunicorn yerine tek dosya çalıştırmak için:
